      ...
      <div className="flex w-full flex-col lg:flex-row items-center gap-20 my-20">
        ...
        <div className="flex-1">
          <p className="mb-10 max-w-2xl font-Ovo">
            With a sharp eye for precision and detail, I excel in{" "}
            <b>AutoCAD </b>
            drawing, ensuring every design meets the highest standards. My
            expertise spans electronics, <b>C++ </b>, and{" "}
            <b>microcontrollers </b>, allowing me to master the complexities of{" "}
            <b>hardware programming </b>
            effortlessly. Specializing in <b>PLC programming </b>, I streamline
            and enhance control systems for peak performance. Leveraging the
            power of <b>Raspberry Pi </b>, I explore innovative solutions and
            push the boundaries of hardware development, constantly seeking to
            create what's next.
          </p>
